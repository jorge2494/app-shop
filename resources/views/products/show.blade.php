...
<div class="header header-filter" style="background-image: url('http://api-tarhiata.michoacan.travel/files/af0a991f666ca273ed1d7e56e2f9e415/place-549-florenciamorales-4.jpg');"></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Seleccioone la cantidad que desea agregar</h4>
      </div>
